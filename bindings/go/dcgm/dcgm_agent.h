 ...
 */
dcgmReturn_t DECLDIR dcgmInit(void);
 ...
 */
dcgmReturn_t DECLDIR dcgmShutdown(void);
 ...
 */
dcgmReturn_t DECLDIR dcgmStopEmbedded(dcgmHandle_t pDcgmHandle);
 ...
 */
dcgmReturn_t DECLDIR dcgmDisconnect(dcgmHandle_t pDcgmHandle);
